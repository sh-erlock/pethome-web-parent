<template>
  <div>
    ...
    <el-form style="margin-top: 40px" :model="shop" ref="shopForm" :rules="formRules" label-position="left" label-width="100px" class="demo-ruleForm login-container">
      ...
      <el-form-item prop="confirmPassword" label="确认密码">
        <el-input type="password" v-model="shop.confirmPassword" auto-complete="off" placeholder="再次输入确认密码！"></el-input>
      </el-form-item>
